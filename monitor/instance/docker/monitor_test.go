...
func setupDockerMonitor(ctrl *gomock.Controller) (monitorinstance.Implementation, *dockerMonitor, *mockpolicy.MockResolver) {
...
func TestStartDockerContainer(t *testing.T) {
	...
	Convey("When I try to initialize a new docker monitor", t, func() {
		...
		dm, dmi, mockPU := setupDockerMonitor(ctrl)
...
func TestHandleStartEvent(t *testing.T) {
	...
	Convey("When I try to initialize a new docker monitor", t, func() {
		...
		dm, dmi, _ := setupDockerMonitor(ctrl)
