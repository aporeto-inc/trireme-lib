...
type CNIMetadataExtractor func(event *eventinfo.EventInfo) (*policy.PURuntime, error)

// KubernetesCNIMetadataExtractor is a systemd based metadata extractor
func KubernetesCNIMetadataExtractor(event *eventinfo.EventInfo) (*policy.PURuntime, error) {
...
func DockerCNIMetadataExtractor(event *eventinfo.EventInfo) (*policy.PURuntime, error) {
