...
// NOTE: taken and adopted from the following files from the kubelet:
// - github.com/kubernetes/kubernetes/pkg/kubelet/container/runtime.go
// - github.com/kubernetes/kubernetes/pkg/kubelet/container/cache.go
//
