...
func (_m *MockContextStore) GetContextInfo(contextID string, context interface{}) error {
	ret := _m.ctrl.Call(_m, "GetContextInfo", contextID, context)
	ret0, _ := ret[0].(error)
	return ret0
}

func (_mr *_MockContextStoreRecorder) GetContextInfo(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "GetContextInfo", arg0, arg1)
}
