...
func (m *MockCommonAPIClient) BuildCachePrune(ctx context.Context) (*types.BuildCachePruneReport, error) {
	ret := m.ctrl.Call(m, "BuildCachePrune", ctx)
...
func (mr *MockCommonAPIClientMockRecorder) BuildCachePrune(ctx interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildCachePrune", reflect.TypeOf((*MockCommonAPIClient)(nil).BuildCachePrune), ctx)
}
...
// BuildCachePrune mocks base method
func (m *MockImageAPIClient) BuildCachePrune(ctx context.Context) (*types.BuildCachePruneReport, error) {
	ret := m.ctrl.Call(m, "BuildCachePrune", ctx)
	ret0, _ := ret[0].(*types.BuildCachePruneReport)
	ret1, _ := ret[1].(error)
	return ret0, ret1
...
// BuildCachePrune indicates an expected call of BuildCachePrune
func (mr *MockImageAPIClientMockRecorder) BuildCachePrune(ctx interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildCachePrune", reflect.TypeOf((*MockImageAPIClient)(nil).BuildCachePrune), ctx)
}
