...
// The 6th argument (bool) indicates if a network namespace should get extracted
type PodMetadataExtractor func(context.Context, client.Client, *runtime.Scheme, *corev1.Pod, policy.RuntimeReader, bool) (*policy.PURuntime, error)
