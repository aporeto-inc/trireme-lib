...
func TestContextIDFromDockerID(t *testing.T) {
	...
	Convey("When I try to retrieve contextID when dockerID length less than 12", t, func() {
		...
		Convey("Then I should get error", func() {
			So(cID, ShouldEqual, "")
			So(err, ShouldResemble, fmt.Errorf("unable to generate context id: dockerid smaller than 12 characters: 6f47830f64"))
		})
	})
	...
	Convey("When I try to retrieve contextID when no dockerID given", t, func() {
		...
		Convey("Then I should get error", func() {
			So(cID, ShouldEqual, "")
			So(err, ShouldResemble, fmt.Errorf("unable to generate context id: empty docker id"))
		})
	})
}
...
func TestStartDockerContainer(t *testing.T) {
	...
	Convey("When I try to initialize a new docker monitor", t, func() {
		...
		Convey("When I try to start default docker container with invalid context ID and killContainerOnPolicyError not set", func() {
			...
			Convey("Then I should get error", func() {
				So(err, ShouldResemble, fmt.Errorf("unable to set policy: container 74cc486f9ec3 kept alive per policy: error"))
			})
		})
		...
		Convey("When I try to start from default docker container with invalid context ID", func() {
			...
			Convey("Then I should get error", func() {
				So(err, ShouldResemble, fmt.Errorf("unable to set policy: killed container 74cc486f9ec3: error"))
			})
		})
		...
		Convey("When I try to start host docker container with error in assigning mark", func() {
			...
			Convey("Then I should get error", func() {
				So(err, ShouldResemble, fmt.Errorf("unable to setup host mode for container 74cc486f9ec3: error"))
			})
		})
...
func TestHandleStartEvent(t *testing.T) {
	...
	Convey("When I try to initialize a new docker monitor", t, func() {
		...
		Convey("When I try to handle start event with invalid ID given and killContainerOnPolicyError is set", func() {
			...
			Convey("Then I should get error", func() {
				So(err, ShouldResemble, fmt.Errorf("unable to read container information: container 74cc486f9ec3 killed: Error: No such container: 74cc486f9ec3256d7bee789853ce05510117c7daf893f90a7577cdcba259d063"))
			})
		})
		...
		Convey("When I try to handle start event with invalid ID given", func() {
			...
			Convey("Then I should get error", func() {
				So(err, ShouldResemble, fmt.Errorf("unable to read container information: container abcc486f9ec3 kept alive per policy: Error: No such container: abcc486f9ec3256d7bee789853ce05510117c7daf893f90a7577cdcba259d063"))
			})
		})
	})
}
	...
	Convey("When I try to initialize a new docker monitor", t, func() {
		...
		Convey("When I try to call extractmetadata with nil docker info", func() {
			...
			Convey("I should get error", func() {
				So(puR, ShouldBeNil)
				So(err, ShouldResemble, fmt.Errorf("docker info is empty"))
			})
		})
	})
}
