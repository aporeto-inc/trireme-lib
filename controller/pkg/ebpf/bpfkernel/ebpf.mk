...
build:
	...
	clang -D__KERNEL__ -D__ASM_SYSREG_H \
		...
		-Wall \
		-Werror \
		-O2 -emit-llvm -c socket-filter-bpf.c \
		...
		-o - | llc -march=bpf -filetype=obj -o "${DEST_DIR}/socket-filter-bpf.o"
	go-bindata -pkg bpfbuild -prefix "${DEST_DIR}/" -modtime 1 -o "${DEST_DIR}/socket-filter-bpf.go" "${DEST_DIR}/socket-filter-bpf.o"
