...
func RegisterTypes() {
	...
	gob.RegisterName("go.aporeto.io/trireme-lib/controller/internal/enforcer/utils/rpcwrapper.DiagnosticsReport_Payload", *(&DiagnosticsReportPayload{}))
	...
	gob.RegisterName("go.aporeto.io/trireme-lib/controller/internal/enforcer/utils/rpcwrapper.RunDiagnostics_Payload", *(&RunDiagnosticsPayload{}))
}
