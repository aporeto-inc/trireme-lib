...
// nolint
func (m *MockTokenAccessor) CreateSynPacketToken(context *pucontext.PUContext, auth *connection.AuthInfo, secrets secrets.Secrets) ([]byte, error) {
	ret := m.ctrl.Call(m, "CreateSynPacketToken", context, auth, secrets)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// nolint
func (mr *MockTokenAccessorMockRecorder) CreateSynPacketToken(context, auth, secrets interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSynPacketToken", reflect.TypeOf((*MockTokenAccessor)(nil).CreateSynPacketToken), context, auth, secrets)
}
