...
const (
	...
	// SelfNetChain to host rules for traffic for the trireme-lib application
	SelfNetChain = chainPrefix + "Self-Net"

	// SelfAppChain to host rule for traffic generated by trireme-lib application
	SelfAppChain             = chainPrefix + "Self-App"
