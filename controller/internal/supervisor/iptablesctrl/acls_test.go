...
func TestAddContainerChain(t *testing.T) {
	...
	Convey("Given an iptables controller", t, func() {
		i, _ := NewInstance(fqconfig.NewFilterQueueWithDefaults(), constants.RemoteContainer, &runtime.Configuration{})
...
// 		i, _ := NewInstance(fqconfig.NewFilterQueueWithDefaults(), constants.LocalServer, &runtime.Configuration{})
// 		iptables := provider.NewTestIptablesProvider()
// 		i.ipt = iptables
...
// 		i, _ := NewInstance(fqconfig.NewFilterQueueWithDefaults(), constants.Sidecar, &runtime.Configuration{})
// 		iptables := provider.NewTestIptablesProvider()
// 		i.ipt = iptables
...
// 		Convey("When I delete the NAT exclusion chain rules and the appPacketIPTableContex ", func() {
// 			iptables.MockDelete(t, func(table string, chain string, rulespec ...string) error {
...
// 		Convey("When I delete the exclusion chain rules and the install in the output chain", func() {
// 			iptables.MockDelete(t, func(table string, chain string, rulespec ...string) error {
// 				return nil
// 			})
// 			err := i.deleteLegacyNATExclusionACLs("", "myset", []string{"10.1.1.3/32"}, "8085")
