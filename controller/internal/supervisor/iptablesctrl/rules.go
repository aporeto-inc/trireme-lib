...
{{.MangleTable}} {{.NetChain}} -s {{.DefaultIP}} -j NFLOG --nflog-group 10 --nflog-prefix {{.DefaultNFLOGDropPrefix}}
...
{{.MangleTable}} {{.NetChain}} -s {{.DefaultIP}} -j NFLOG --nflog-group 11 --nflog-prefix {{.DefaultNFLOGDropPrefix}}
