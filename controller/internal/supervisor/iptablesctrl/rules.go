...
{{.MangleTable}} {{.AppChain}} -d 0.0.0.0/0  -p tcp --tcp-flags RST, RST -j LOG --log-prefix RST-APP
{{.MangleTable}} {{.AppChain}} -d 0.0.0.0/0  -p tcp --tcp-flags FIN, FIN -j LOG --log-prefix FIN-APP
...
{{.MangleTable}} {{.AppChain}} -d 0.0.0.0/0  -p tcp --tcp-flags RST, RST -j LOG --log-prefix RST-NET
{{.MangleTable}} {{.AppChain}} -d 0.0.0.0/0  -p tcp --tcp-flags FIN, FIN -j LOG --log-prefix FIN-NET
