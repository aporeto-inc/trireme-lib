...
func TestNewInstance(t *testing.T) {
	...
	Convey("When I create a new iptables instance", t, func() {
		...
		Convey("If I create a local implemenetation and iptables exists", func() {
			i, err := NewInstance(fqconfig.NewFilterQueueWithDefaults(), constants.LocalContainer, portset.New())
		...
		Convey("If I create a remote implemenetation and iptables exists", func() {
			i, err := NewInstance(fqconfig.NewFilterQueueWithDefaults(), constants.RemoteContainer, portset.New())
			Convey("It should succeed", func() {
				So(i, ShouldNotBeNil)
				So(err, ShouldBeNil)
...
func TestStop(t *testing.T) {
	Convey("Given an iptables controller", t, func() {
		i, _ := NewInstance(fqconfig.NewFilterQueueWithDefaults(), constants.RemoteContainer, portset.New())
		iptables := provider.NewTestIptablesProvider()
		i.ipt = iptables
