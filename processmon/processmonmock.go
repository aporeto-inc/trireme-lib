...
type mockedMethods struct {
	...
	LaunchProcessMock func(string, int, string, rpcwrapper.RPCClient, string, string) error
...
type TestProcessManager interface {
	...
	MockLaunchProcess(t *testing.T, impl func(string, int, string, rpcwrapper.RPCClient, string, string) error)
...
func (m *testProcessMon) MockLaunchProcess(t *testing.T, impl func(string, int, string, rpcwrapper.RPCClient, string, string) error) {
...
func (m *testProcessMon) LaunchProcess(contextID string, refPid int, sandboxKey string, rpchdl rpcwrapper.RPCClient, processname string, statssecret string) error {
	if mock := m.currentMocks(m.currentTest); mock != nil && mock.LaunchProcessMock != nil {
		return mock.LaunchProcessMock(contextID, refPid, sandboxKey, rpchdl, processname, statssecret)
